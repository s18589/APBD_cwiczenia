    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad1()
        {
            ...
            res.ToList().ForEach(line => Console.WriteLine(line));
        }
        ...
        public void Przyklad2()
        {
            ...
            var res = from emp in Emps where emp.Job == "Frontend programmer" && emp.Salary > 1000 orderby emp.Ename descending select emp;
            res.ToList().ForEach(line => Console.WriteLine(line));
        ...
        public void Przyklad4()
        {
            ...
            var res = from emp in Emps where emp.Salary == (Emps.Max(emp => emp.Salary)) select emp;
            res.ToList().ForEach(line => Console.WriteLine(line));
        }
        ...
        public void Przyklad10()
        {
            ...
            var resTotal = res1.Union(res2);
            resTotal.ToList().ForEach(line => Console.WriteLine(line));
        ...
        public void Przyklad11()
        {
            ...
            var res = Emps.Select(emp => emp.Salary)
